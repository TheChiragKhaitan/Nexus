...
const Toolbar = ({canRedo, canUndo, canvasState, setCanvasState, undo, redo}: ToolbarProps) => {
    return ( 
...
export const ToolbarSkeleton = () => {
    return ( 
        <div className="animate-pulse absolute top-[50%] -translate-y-[50%] left-2 flex flex-col gap-y-4 h-[360px] w-[52px] shadow-md rounded-md bg-white" />
