...
interface SelectionToolsProps {
    camera: Camera
    setLastUsedColour: (color: Color) => void
}
...
export const SelectionTools = memo(({ camera, setLastUsedColour }: SelectionToolsProps) => {
    ...
    return (
        <div className="absolute p-3 rounded-xl bg-white border shadow-sm flex select-none" style={{ transform: `translate(calc(${x}px - 50%), calc(${y - 16}px - 100%))` }}>
