...
const BoardCard = ({id, title, authorId, authorName, createdAt, imageUrl, orgId, isFavourite}: BoardCardProps) => {
            ...
            <div className="group aspect-[100/127] border rounded-lg flex flex-col justify-between overflow-hidden">
                <div className="relative flex-1 bg-amber-50">
                    ...
                    <Actions id={id} title={title} side="right" >
                        <button aria-hidden='true' className="absolute top-1 right-1 opacity-0 group-hover:opacity-100 transition-opacity px-3 py-2 outline-none">
